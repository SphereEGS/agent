...
# ROI Configuration
DEFAULT_ROI_CONFIG_PATH = os.getenv("ROI_CONFIG_PATH", "config.json")
DEFAULT_TRIGGER_ROI_CONFIG_PATH = os.getenv("TRIGGER_ROI_CONFIG_PATH", "trigger_roi.json")
ENABLE_TRIGGER_ROI = os.getenv("ENABLE_TRIGGER_ROI", "true").lower() == "true"
TRIGGER_PATIENCE = int(os.getenv("TRIGGER_PATIENCE", "5"))  # Number of frames to wait after last trigger before deactivating detection
MOTION_THRESHOLD = float(os.getenv("MOTION_THRESHOLD", "500"))  # Minimum motion area to trigger detection
